...
async def _host_game(
    ...
    print(f"Hosting game on map {map_settings.name} with players: {', '.join(str(p) for p in players)}")
    # assert any((isinstance(p, (Human, Bot))) for p in players), "At least one player must be Human or Bot"
